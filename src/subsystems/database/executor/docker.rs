...
use crate::{
    database::data::StoredDatabase,
    subsystems::database::resources::{ContainerState, ResourceUsage},
};
...
impl super::ProcessHandle for DockerProcessHandle {
    ...
    async fn update_resources(&self, data: &StoredDatabase) -> Result<(), anyhow::Error> {
